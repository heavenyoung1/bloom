...
class PDFGenerator:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        if config_path is None:
            ...
            config_path = base_dir / 'infrastructure' / 'pdf' / 'config' / 'invoice_fields.json'
    ...
    def _create_overlay_pdf(self, data: Dict[str, str], fields_config: Dict[str, Any]) -> BytesIO:
        '''
    ...
    def fill_invoice_template(
        ...
        try:
            ...
            logger.info(f'PDF документ успешно сгенерирован для платежа ID={payment.id}')
            return result
